{
  ...
  "package": {
    "name": "InOut-x8",
    "version": "2.1",
    "description": "InOut-x8:  8 bits Input-Output block. Verilog implementation",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "0da55e9f-b921-4632-8e03-42dfd42634ad",
          "type": "basic.input",
          "data": {
            "name": "pin",
            "virtual": true,
        ...
        {
          "id": "c5c7b7d3-ff01-408d-984b-936bfc14fe12",
          "type": "basic.output",
          "data": {
            "name": "",
            "virtual": true,
        ...
        {
          "id": "5328134c-6e10-4149-a341-4f0ad47f8370",
          "type": "basic.input",
          "data": {
            "name": "dout",
            "virtual": true,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "c5c7b7d3-ff01-408d-984b-936bfc14fe12",
            "port": "in"
          },
          "size": 8
        },
        {
          "source": {
            "block": "0da55e9f-b921-4632-8e03-42dfd42634ad",
            "port": "out"
          },
          "target": {
            "block": "d39b28a8-a8dc-48d1-85bf-8931963de8b1",
        ...
        {
          "source": {
            "block": "5328134c-6e10-4149-a341-4f0ad47f8370",
            "port": "out"
          },
          "target": {
            "block": "d39b28a8-a8dc-48d1-85bf-8931963de8b1",
