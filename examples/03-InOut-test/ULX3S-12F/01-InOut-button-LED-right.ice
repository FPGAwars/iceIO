{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "2ddcc227-1051-49ce-b2ce-81ea9e794a36",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "eb0f6d54-8a9a-4fac-b895-837c35d50d0f",
          "type": "basic.input",
          "data": {
            "name": "OUTPUT",
            "pins": [
        ...
        {
          "id": "cffe851e-fe46-41f7-bbbe-79e9049abb78",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "bc94743b-4580-46b5-be6c-8360173ebf3d",
          "type": "basic.output",
          "data": {
            "name": "INPUT",
            "pins": [
        ...
        {
          "id": "1c77a67b-298f-4d75-81bd-46d42ae2f400",
          "type": "basic.input",
          "data": {
            "name": "Button",
            "pins": [
        ...
        {
          "id": "b30a0af8-24e5-4f57-b015-340dc1f2f230",
          "type": "basic.output",
          "data": {
            "name": "INOUT",
            "pins": [
        ...
        {
          "id": "34298212-85f9-4e2e-9664-6ebf0225f476",
          "type": "basic.input",
          "data": {
            "name": "Button",
            "pins": [
        ...
        {
          "id": "f28eda9b-8f0f-41fc-a77a-aff3fdfa8765",
        ...
        {
          "id": "4503ee01-6ec7-4d0e-966c-0c9deffd15e7",
        ...
        {
          "id": "c4c33b64-78ed-4492-af6c-154e6526fc1f",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "navy",
            "name": "dout",
        ...
        {
          "id": "cc4715da-d333-4aa4-9edb-87dace5a390d",
          "type": "basic.inputLabel",
          "data": {
            "blockColor": "navy",
            "name": "dout",
        ...
        {
          "id": "341acb2e-a86a-4683-9f68-bc0756ffaae5",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "oe",
        ...
        {
          "id": "53737cfb-7e95-4226-b776-0c2cb8ccfefe",
          "type": "basic.constant",
          "data": {
            "name": "Divisor",
            "value": "6000000",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Configure as input/output:\n* 0: Input\n* 1: Output",
            "readonly": true
          },
          "position": {
            "x": -232,
        ...
        {
          "id": "542a90c9-f42b-43d4-b74a-6cb74ce7a2c0",
        ...
        {
          "id": "a540950e-4db4-4ebf-add7-f90eae5e92f8",
        ...
        {
          "id": "1324caf4-7e9a-45c7-ac01-a01a5b6e5804",
          "type": "basic.info",
          "data": {
            "info": "1 when configured as input",
            "readonly": true
          },
          "position": {
            "x": 400,
        ...
        {
          "id": "d5f94635-9e61-47cf-8fb8-6b4f306463d5",
          "type": "basic.info",
          "data": {
            "info": "Connect to GN0 using an  \nexternal wire",
            "readonly": true
          },
          "position": {
            "x": -88,
        ...
        {
          "id": "12ad71f9-0ddb-4c2f-9ffe-3535b84d14ab",
          "type": "basic.info",
          "data": {
            "info": "Connect to GN0 using an  \nexternal wire",
            "readonly": true
        ...
        {
          "id": "41091f47-0d22-4d90-a6b0-4aef58102a3e",
        ...
        {
          "id": "17834b94-6102-4b5f-ac24-d5411ca45a30",
        ...
        {
          "id": "1845c3bc-ec99-4c79-99bc-c10c12e4c6b1",
          "type": "basic.info",
          "data": {
            "info": "1-sec period  \nsquare signal",
            "readonly": true
        ...
        {
          "id": "2c2fd246-4eda-4cee-9618-8fbec1752e20",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "9c027a9c-5a4f-4f9d-8246-52cfba0aefe5",
          "type": "basic.info",
          "data": {
            "info": "1-bit constant",
            "readonly": true
        ...
        {
          "id": "650378f0-fc2e-40a7-b79c-78e55e22671e",
          "type": "basic.info",
          "data": {
            "info": "Output pin",
            "readonly": true
        ...
        {
          "id": "c4207dd9-f8fc-4cb4-b31b-dbc2f20ed18b",
        ...
        {
          "id": "121697f9-65f1-459c-b5d0-58180b969ca6",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "4f582568-5742-4a6b-aad5-3dae2904a310",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "d3475ee0-25da-491e-86ee-30d76dff25cd",
      ...
      "wires": [
        {
          "source": {
            "block": "34298212-85f9-4e2e-9664-6ebf0225f476",
            "port": "out"
          },
          "target": {
            "block": "4503ee01-6ec7-4d0e-966c-0c9deffd15e7",
            "port": "inlabel"
          }
        },
        {
          "source": {
            "block": "f28eda9b-8f0f-41fc-a77a-aff3fdfa8765",
            "port": "outlabel"
          },
          "target": {
            "block": "d3475ee0-25da-491e-86ee-30d76dff25cd",
        ...
        {
          "source": {
            "block": "341acb2e-a86a-4683-9f68-bc0756ffaae5",
            "port": "outlabel"
          },
          "target": {
            "block": "a540950e-4db4-4ebf-add7-f90eae5e92f8",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
          "source": {
            "block": "17834b94-6102-4b5f-ac24-d5411ca45a30",
            "port": "4e8afe74-8f38-4873-97ee-f7585d99a4aa"
          },
          "target": {
            "block": "cc4715da-d333-4aa4-9edb-87dace5a390d",
            "port": "inlabel"
          }
        },
        {
          "source": {
            "block": "c4c33b64-78ed-4492-af6c-154e6526fc1f",
            "port": "outlabel"
          },
          "target": {
            "block": "d3475ee0-25da-491e-86ee-30d76dff25cd",
        ...
        {
          "source": {
            "block": "1c77a67b-298f-4d75-81bd-46d42ae2f400",
            "port": "out"
          },
          "target": {
            "block": "bc94743b-4580-46b5-be6c-8360173ebf3d",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "eb0f6d54-8a9a-4fac-b895-837c35d50d0f",
            "port": "out"
          },
          "target": {
            "block": "cffe851e-fe46-41f7-bbbe-79e9049abb78",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "53737cfb-7e95-4226-b776-0c2cb8ccfefe",
            "port": "constant-out"
          },
          "target": {
            "block": "41091f47-0d22-4d90-a6b0-4aef58102a3e",
        ...
        {
          "source": {
            "block": "542a90c9-f42b-43d4-b74a-6cb74ce7a2c0",
        ...
        {
          "source": {
            "block": "c4207dd9-f8fc-4cb4-b31b-dbc2f20ed18b",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "2ddcc227-1051-49ce-b2ce-81ea9e794a36",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "b30a0af8-24e5-4f57-b015-340dc1f2f230",
            "port": "in"
          }
        }
      ]
