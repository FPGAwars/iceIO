{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "e066d0ca-3ea7-4374-99b9-b2d31ae9b133",
          "type": "basic.input",
          "data": {
            "name": "Btn",
            "range": "[3:0]",
        ...
        {
          "id": "1819e0b3-8627-4bfb-b7bf-a8b8cfdfc27d",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[3:0]",
        ...
        {
          "id": "5a6511f7-ecc4-4b0d-afbd-f27ee7ad0900",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "5a6511f7-ecc4-4b0d-afbd-f27ee7ad0900",
            "port": "5d9cf2dd-adfe-4374-859f-3fd1e40f3df7"
          }
        },
        {
          "source": {
            "block": "e066d0ca-3ea7-4374-99b9-b2d31ae9b133",
            "port": "out"
          },
          "target": {
            "block": "5a6511f7-ecc4-4b0d-afbd-f27ee7ad0900",
        ...
        },
        {
          ...
          "target": {
            "block": "1819e0b3-8627-4bfb-b7bf-a8b8cfdfc27d",
            "port": "in"
          },
          "size": 4
        }
