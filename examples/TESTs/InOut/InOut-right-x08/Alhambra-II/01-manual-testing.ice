{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "6b590813-15f4-455b-b1eb-af4d0fb53cba",
          "type": "basic.output",
          "data": {
            "name": "BTN",
            "virtual": false,
        ...
        {
          "id": "168e671a-f877-4d69-8bb5-178e42e6000c",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        {
          "id": "67173be3-4186-4e14-a011-7b21d788e596",
          "type": "fb067ac4887173abc28e8acfba8ff75f62f5ed2e",
          "position": {
            "x": 264,
            "y": 136
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "67173be3-4186-4e14-a011-7b21d788e596",
        ...
        },
        {
          "source": {
            "block": "67173be3-4186-4e14-a011-7b21d788e596",
            "port": "1a805a48-d82b-4205-bf30-4f715ec4e32c"
          },
          "target": {
            "block": "6b590813-15f4-455b-b1eb-af4d0fb53cba",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          "source": {
            "block": "67173be3-4186-4e14-a011-7b21d788e596",
            "port": "00fff54d-2e3a-424a-a64b-29267e245bb5"
          },
          "target": {
            "block": "168e671a-f877-4d69-8bb5-178e42e6000c",
            "port": "in"
          },
          "vertices": [
            {
  ...
  "dependencies": {
    ...
    "fb067ac4887173abc28e8acfba8ff75f62f5ed2e": {
      "package": {
        "name": "InOut-x8-right",
        "version": "2.1",
        "description": "InOut-x8-Right:  8 bits Input-Output block (Pin on the Right). Verilog implementation",
      ...
      "design": {
        ...
        "graph": {
          "blocks": [
            ...
            {
              "id": "1a805a48-d82b-4205-bf30-4f715ec4e32c",
              "type": "basic.output",
              "data": {
                "name": "pin",
                "virtual": true,
            ...
            {
              "id": "00fff54d-2e3a-424a-a64b-29267e245bb5",
              "type": "basic.output",
              "data": {
                "name": "din",
                "virtual": true,
            ...
            {
              "id": "fdbcddbc-9177-4efd-8404-eeffcb36dd2f",
              "type": "basic.input",
              "data": {
                "name": "dout",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "fdbcddbc-9177-4efd-8404-eeffcb36dd2f",
                "port": "out"
              },
              "target": {
                "block": "3fabc95e-fe92-4552-85da-88cc0eca6286",
            ...
            },
            {
              ...
              "target": {
                "block": "00fff54d-2e3a-424a-a64b-29267e245bb5",
                "port": "in"
              },
              "size": 8
            },
            {
              ...
              "target": {
                "block": "1a805a48-d82b-4205-bf30-4f715ec4e32c",
                "port": "in"
              },
              "size": 8
            }
