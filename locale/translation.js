...
gettext('InOut-right-x3');
gettext('InOut-x3-Right_ICE40:  3 bits Input-Output block for the ICE40 FPGA Family (Pin on the Right)');
gettext('InOut-x3');
gettext('InOut-x3_ICE40:  3 bits Input-Output block for the ICE40 FPGA Family');
gettext('InOut-right-x4');
gettext('InOut-x4-Right_ICE40:  4 bits Input-Output block for the ICE40 FPGA Family (Pin on the Right)');
gettext('InOut-x4');
gettext('InOut-x4_ICE40:  4 bits Input-Output block for the ICE40 FPGA Family');
gettext('ICE40');
gettext('Pull-up-x1');
